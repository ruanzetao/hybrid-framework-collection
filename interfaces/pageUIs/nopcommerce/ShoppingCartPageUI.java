...
public class ShoppingCartPageUI {
	...
	//Input fields:
	public static final String EDIT_SHOPPING_CART_BUTTON = "xpath=//div[@class='edit-item']/a";
	...
	public static final String REMOVE_PRODUCT_MESSAGE = "xpath=//div[@class='no-data']";
	public static final String QUANTITY_TEXTBOX = "xpath=//input[@class='qty-input']";
	public static final String CITY_TEXTBOX = "xpath=//input[@id='BillingNewAddress_City']";
